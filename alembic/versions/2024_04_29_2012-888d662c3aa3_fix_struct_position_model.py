...
Revision ID: 888d662c3aa3
Revises: 4f2442d5469c
Create Date: 2024-04-29 20:12:28.840178
...
revision: str = "888d662c3aa3"
down_revision: Union[str, None] = "4f2442d5469c"
...
def downgrade() -> None:
    ...
    op.add_column(
        "struct_adm_positions",
        sa.Column("note", sa.VARCHAR(length=256), autoincrement=False, nullable=False),
    )
    op.alter_column(
        "struct_adm_positions",
        "path",
    ...
    op.drop_column(
        "struct_adm_positions",
        "((|Rf|rF|br|rB|Rb|FR|b|B|rb|rf|f|fr|U|BR|bR|F|R|fR|Br|RB|Fr|u|RF|r)'[^\\n'\\\\]*(?:\\\\.[^\\n'\\\\]*)*'|(|Rf|rF|br|rB|Rb|FR|b|B|rb|rf|f|fr|U|BR|bR|F|R|fR|Br|RB|Fr|u|RF|r)\"[^\\n\"\\\\]*(?:\\\\.[^\\n\"\\\\]*)*\")",
    )
    op.alter_column(
        "role",
        "role",
