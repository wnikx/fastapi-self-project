"""add Struct Position model

Revision ID: 4f2442d5469c
Revises: e5af2d968842
Create Date: 2024-04-29 19:28:30.343711
...
revision: str = "4f2442d5469c"
down_revision: Union[str, None] = "e5af2d968842"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "((|rB|Br|Rb|rb|Fr|U|br|B|RB|RF|bR|fr|rf|rF|fR|R|f|Rf|r|u|b|FR|F|BR)'[^\\n'\\\\]*(?:\\\\.[^\\n'\\\\]*)*'|(|rB|Br|Rb|rb|Fr|U|br|B|RB|RF|bR|fr|rf|rF|fR|R|f|Rf|r|u|b|FR|F|BR)\"[^\\n\"\\\\]*(?:\\\\.[^\\n\"\\\\]*)*\")",
...
def downgrade() -> None:
    ...
    op.drop_index("ix_nodes_path", table_name="struct_adm_positions", postgresql_using="gist")
